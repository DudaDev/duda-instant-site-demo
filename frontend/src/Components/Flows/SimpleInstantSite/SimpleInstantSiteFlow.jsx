...
function SimpleInstantSiteFlow() {
  ...
  function autofill() {
    ...
    setForm({
      ...
      "city": 'San Francisco',
      "country": 'US',
      "businessDescription": "Duda is the leading web design platform for companies that offer web design services to small businesses. We serve all types of customers, from freelance web professionals and digital agencies, all the way up to the largest hosting companies and online publishers in the world.",
          ...
          <FormControl style={{ marginBottom: '30px', color: 'white' }}>
            ...
            <Grid container>
              ...
              <Grid item xs={2} style={{ marginTop: '30px' }}>
                <SimpleTemplateSelector handleChange={handleChange} form={form}/>
              </Grid>
              ...
              <Grid item xs={6} style={{ paddingRight: '30px', marginBottom: '10px' }}>
                ...
                <TextField onChange={handleChange} variant="filled" value={form.phoneNumber} disabled={updating} name="phoneNumber" label="Phone Number" placeholder="(800) 867-5309" style={{ width: '100%' }}/>
                <TextField onChange={handleChange} variant="filled" value={form.email} disabled={updating} name="email" label="Email" placeholder="sales@company.site" style={{ width: '100%' }}/>
              </Grid>
              ...
              <Grid item xs={6}>
                ...
                <TextField onChange={handleChange} variant="filled" value={form.businessDescription} disabled={updating} multiline rowsMax="4" rows='4' name="businessDescription" label="Description" style={{ width: '100%' }}/>
              </Grid>
